    ...
    <div>
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Clever Coder</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      {/* CONTAINER */}
          ...
          <div className="bg-primary-foreground p-4 rounded-lg">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>clevercoder0307@gmail.com</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-bold">Phone Number:</span>
                <span>+91 72490084224</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Badge className="rounded-md">Admin</Badge>
              </div>
              <p className="text-sm text-muted-foreground mt-4">
                Joined on 2025.07.03
              </p>
            </div>
          </div>
          {/* CARDLIST CONTAINER */}
